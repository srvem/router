...
var SrvRouter = (function (_super) {
    ...
    SrvRouter.prototype.main = function () {
        ...
        for (var _i = 0, matches_1 = matches; _i < matches_1.length; _i++) {
            ...
            for (var _a = 0, _b = route.handlers; _a < _b.length; _a++) {
                var handler = _b[_a];
    ...
    SrvRouter.prototype.handleNext = function (handlers) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                if (this.i !== null && handlers[++this.i])
                    return [2, handlers[this.i](this.request, this.response, function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2, this.handleNext(handlers)];
                        }); }); })
